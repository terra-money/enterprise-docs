...
A multisig DAO creates a transaction proposal. The multisig has 5 members and a threshold of 66%:
...
<Admonition type="tip" title="Non-voting members">

A wallet with a weight of `0` is still considered a member of a DAO, but they do not have the right to vote on proposals. 
