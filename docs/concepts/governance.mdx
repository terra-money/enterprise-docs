...
| Proposal to execute message           | This proposal type allows members to craft generic Cosmos/Wasm messages which will be executed by the DAO. This allows the DAO to send funds, interact with smart contracts, delegate/undelegate LUNA from the treasury, etc. Refer to the [Message Templates](../guides/messages.mdx) section for examples of supported messages.                                                                                                                                     |
