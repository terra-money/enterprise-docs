...
There are two main proposal types: DAO configuraiton proposals and Text proposals. 
...
Governance parameters are outlined in the DAO configuration during creation of the DAO. All DAOs have the following governance parameters:
