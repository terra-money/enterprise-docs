...
This section outlines the data structures for DAO creation. 
...
There are three types of DAO which can be created using Enterprise:
...
_`NewTokenMembershipInfo`_
is used to instantiate new DAO governance membership token. This information is similar to a CW20 token's instantiation info. 
