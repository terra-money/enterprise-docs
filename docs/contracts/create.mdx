...
- a [CW20 Token DAO](../concepts/about.mdx#token-daos)
- a [CW721 NFT DAO](../concepts/about.mdx#nft-daos)
...
New multisig DAOs require the addresses and weights of all the multisig members. To learn more about multisig weights, visit the [Configurations and parameters page](../concepts/config.mdx#weight-and-threshold)
