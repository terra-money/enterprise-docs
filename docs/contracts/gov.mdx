...
Upgrades DAO to a new Enterprise code, enabling the DAO to benefit from new features and bug fixes.
...
Updates multisig members for this DAO, through specifying new weights for addresses. Only available in multisig DAOs.
