...
5. Type in a title and a description for your proposal. Depending on the proposal you're creating, you'll need to update different parameters. For execute message proposals, you'll need to provide a valid cosmos/wasm message. Refer to [Message Templates](../guides/messages.mdx#proposals) for examples of what messages are supported.
