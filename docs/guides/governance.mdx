...
5. Type in a title and a description for your proposal. If you are making a configuration proposal, scroll down and change the appropriate [parameter](../concepts/config.mdx).
