# Enterprise Docs style guide

Use the following style guide to ensure the Enterprise documentation is understandable, useful, consistent, and organized.

## Guiding principles

The Enterprise Docs are:
...
The Enterprise Docs are intended for a diverse, international audience. Use natural language, and talk like a person. Avoid technical jargon and obscure words. Use your writing to present Enterprise. Don't use Enterprise to present your writing.

### Simple

Write less. Say more. 

Simplicity is at the heart of the Enterprise style. Writers and readers will understand each other better with a minimalist approach. Emphasize clarity over complexity. 
...
The Enterprise Docs are structured using the [Diataxis framework](https://diataxis.fr/). Each document should fall into one of the four categories: tutorials, how-to guides, explanation, and reference. Try not to overlap categories in the same document.
...
Example: The Enterprisein initial setup
...
Example: What is Enterprise?

### Reference

Informational material used for quick reference. 

Example: The Enterprised commands and subcommands

## Voice

All writing in the Enterprise Docs is written in the second or third person. 
